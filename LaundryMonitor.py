...
def machine_starting(min_start_delta, min_stop_delta, pin):
    ...
    min_start_delta = dt.timedelta(seconds = min_start_delta)           # Min vibration time to declare washer has started
    min_stop_delta = dt.timedelta(seconds = min_stop_delta)            # Min vibration time to declare washer has finished
